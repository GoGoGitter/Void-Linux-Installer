...
echo "-------------------------------------------------"
doas xbps-install -Sy xfce4 xfce4-battery-plugin xfce4-clipman-plugin xfce4-screenshooter-plugin xfce4-pulseaudio-plugin lightdm lightdm-gtk3-greeter light-locker
